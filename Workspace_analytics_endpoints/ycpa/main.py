...
from ycpa.api.v1.endpoints.workspace_analytics import router as workspace_analytics_router
...
app.include_router(workspace_analytics_router, prefix=settings.API_V1_PREFIX)
