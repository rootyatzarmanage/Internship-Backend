...
from backend.api.v1.endpoints.bar_chart import bar_chart_router
from backend.api.v1.endpoints.area_chart import area_chart_router
...
app.include_router(bar_chart_router,prefix=settings.API_V1_PREFIX)
app.include_router(area_chart_router,prefix=settings.API_V1_PREFIX)
